...
Both **team-phoenix** and **team-ashrend** run on the same Oracle Cloud VM from separate clones of this repo.
...
- team-ashrend: `~/team-ashrend/`

## Deploying an update

```bash
cd ~/team-phoenix   # or ~/team-ashrend
git pull
npm run build
pm2 restart team-phoenix   # or team-ashrend
```
...
- `DISCORD_GUILD_ID` — team-phoenix: `1333287434473177109`, team-ashrend: `1329669121733951581`
- `APPS_SCRIPT_URL` — different Apps Script deployment per server
- `PORT` — team-phoenix omitted (defaults to 3000), team-ashrend: `3001`
